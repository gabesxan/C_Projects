...
const NAV = [
  ...
  { to: '/minha-saude', label: 'Minha saúde', icon: '💜', roles: ['PACIENTE'] },
  { to: '/recepcao', label: 'Recepcao', icon: '🎫', roles: ['ADMIN', 'CADASTRO', 'MEDICO', 'ENFERMAGEM'] },
  ...
  { to: '/financeiro', label: 'Financeiro', icon: '💰', roles: ['ADMIN', 'CADASTRO'] },
