...
const NAV = [
  ...
  { to: '/minha-saude/prontuarios', label: 'Prontuários', icon: 'record', roles: ['PACIENTE'] },
  { to: '/minha-saude/financeiro', label: 'Financeiro', icon: 'billing', roles: ['PACIENTE'] },
  { to: '/minha-saude/solicitacoes', label: 'Solicitações', icon: 'alert', roles: ['PACIENTE'] },
